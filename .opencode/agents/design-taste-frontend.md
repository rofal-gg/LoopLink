...
description: Anti-slop frontend agent for landing pages, portfolios, and redesigns. Reads the brief, infers the design direction, ships non-templated interfaces, uses real design systems when applicable, audits before redesigns, and runs a strict pre-flight check.
mode: all
---
